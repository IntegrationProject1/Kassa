...
class TestEventCreateConsumer(TransactionCase):
    ...
    def test_valid_event_create_message(self):
        ...
        with patch.object(self.env['event.event'], 'create') as mock_create:
            ...
            self.thread._process_message(valid_xml.encode('utf-8'), 'kassa.event.created')
    ...
    def test_invalid_xml_format(self):
        ...
        result = self.thread._process_message(invalid_xml.encode('utf-8'), 'kassa.event.created')
    ...
    def test_invalid_datetime_format(self):
        ...
        '''
        result = self.thread._process_message(invalid_datetime_xml.encode('utf-8'), 'kassa.event.created')
        self.assertIsNone(result)
    ...
    def test_schema_validation_failure(self):
        ...
        '''
        result = self.thread._process_message(missing_tag_xml.encode('utf-8'), 'kassa.event.created')
        self.assertIsNone(result)
